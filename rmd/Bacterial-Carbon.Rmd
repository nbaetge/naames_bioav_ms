...
bigelow <- read_csv("~/GITHUB/naames_bioav_ms/Input/N2-4_BactC_Processing.csv") %>% 
...
i.gf75 <- readRDS("~/GITHUB/naames_bioav_ms/Output/tidy_bacterial_abundance.rds") %>% 
  select(Season:cells) %>% 
...
s.gf75 <- readRDS("~/GITHUB/naames_bioav_ms/Output/tidy_bacterial_abundance.rds") %>% 
  select(Season:cells) %>% 
  filter(!Timepoint == 0) %>% 
...
fg_cell.qc %>% 
  ...
  saveRDS(., "~/GITHUB/naames_bioav_ms/Output/processed_bacterial_carbon.rds")
```
