...
```{r N2 Control plots, echo = FALSE, warning = FALSE, message = FALSE, fig.height = 8, fig.width = 8}
filtered_data %>% 
  filter(Cruise == "AT34") %>% 
  group_by(Station, Bottle) %>%
  ...
  facet_grid(rows = "Station", scales = "free") +
  ...
  plot_annotation( title = "NAAMES 2 Surface DOC Remin Experiments" ) 

```


There looks to be some poor replication between the experiments conducted at station 4:
...
```{r TW addition plots, include = FALSE, echo = FALSE, warning = FALSE, message = FALSE, fig.height = 10, fig.width = 10}
# oc_p %>% 
...
```{r N3 Control plots, echo = FALSE, warning = FALSE, message = FALSE, fig.height = 8, fig.width = 8}
filtered_data %>% 
  filter(Cruise == "AT38") %>%  
  group_by(Station, Bottle) %>%
  ...
  plot_annotation( title = "NAAMES 3 Surface DOC Remin Experiments" ) 

```


```{r Mixing plots, include = FALSE, echo = FALSE, warning = FALSE, message = FALSE, fig.height = 8, fig.width = 10}
# oc_p %>% 
...
```{r Phyto addition plots, include = FALSE, echo = FALSE, warning = FALSE, message = FALSE, fig.height = 8, fig.width = 10}
# oc_p %>% 
...
```{r Syn lys latitude plots, include = FALSE, echo = FALSE, warning = FALSE, message = FALSE, fig.height = 8, fig.width = 10}
# oc_p %>% 
...
```{r N4 Control plots, echo = FALSE, warning = FALSE, message = FALSE, fig.height = 8, fig.width = 8}
filtered_data %>% 
...
filtered_data %>% 
  ...
  plot_annotation( title = "NAAMES 4 Surface DOC Remin Experiments" ) 

```

The replication between experiments at Station 4 is poor. 

```{r Addition plots, include = FALSE, echo = FALSE, warning = FALSE, message = FALSE, fig.height = 6, fig.width = 10}
# oc_p %>% 
...
```{r Parallels, include = FALSE, echo = FALSE, warning = FALSE, message = FALSE, fig.height = 8, fig.width = 14}
# oc_p %>% 
