...
```{r message = F}
oc.df <- read_csv("~/GITHUB/naames_bioav_ms/Input/N2-4_DOC_Remin_Master.csv") %>%
...
```{r echo = FALSE, warning = FALSE, message = FALSE, fig.height = 4, fig.width = 8, fig.align = "center", warning = FALSE}
ptoc_pdoc.data %>% 
  ...
  custom_theme() +
   annotate( geom = "text", label = expression(atop("y = 0.97x + 1.81", paste("r"^2,"= 0.95, ", italic("p "), "<< 0.01"))), x = 75, y = 55, size = 3) +
  ...
  geom_point( fill = "white", shape = 21, size = 4, alpha = 0.7 ) +
  labs(x = expression(italic(paste("∆TOC, µmol C L"^-1))), y = expression(italic(paste("∆DOC, µmol C L"^-1)))) +
  custom_theme() +
   annotate( geom = "text", label = expression(atop("y = 0.97x - 0.03", paste("r"^2,"= 0.94, ", italic("p "), "<< 0.01"))), x = 20, y = 0.5, size = 3) +
...
toc_ptoc.data %>% 
  ...
  custom_theme() +
   annotate( geom = "text", label = expression(atop("y = 0.93x + 2.20", paste("r"^2,"= 0.92, ", italic("p "), "<< 0.01"))), x = 73, y = 53, size = 3) +
  ...
  geom_point( fill = "white", shape = 21, size = 4, alpha = 0.7 ) +
  labs(x = expression(paste("Bottle ∆TOC, µmol C L"^-1)), y = expression(paste("Vial ∆TOC, µmol C L"^-1)), caption = "Solid line represents the 1:1 line.") +
  custom_theme() +
   annotate( geom = "text", label = expression(atop("y = 0.86x + 2.48", paste("r"^2,"= 0.84, ", italic("p "), "<< 0.01"))), x = 15, y = 0.2, size = 3) +
  theme(plot.caption = element_text(face = "italic")) 
