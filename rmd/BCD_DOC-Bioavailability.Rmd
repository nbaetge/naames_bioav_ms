...
ddoc.bar / bioav_doc.bar + plot_annotation(caption = "Experiemnts without long-term DOC bioavailability estimates have been omitted from this plot")
...
(reg1.plot + reg2.plot) / (reg7.plot + reg4.plot)
