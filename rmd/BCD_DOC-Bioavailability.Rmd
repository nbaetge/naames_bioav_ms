...
```{r echo = FALSE, warning = FALSE, message = FALSE, fig.height = 16, fig.width = 7, fig.align = "center", warning = FALSE}
...
npp.boxplot / bp.boxplot / ba.boxplot / mew.boxplot / deldoc.boxplot +
