...
custom.colors <- c("AT39" = "#377EB8", "AT34" = "#4DAF4A", "AT38" = "#E41A1C", "AT32" = "#FF7F00", "Temperate" = "#A6CEE3", "Subpolar" = "#377EB8", "Subtropical" = "#FB9A99", "GS/Sargasso" = "#E41A1C", "Early Spring" = "#377EB8", "Late Spring" = "#4DAF4A","Early Autumn" = "#E41A1C", "Summer" = "#E41A1C", "Late Autumn" = "#FF7F00", "Early Winter" = "#FF7F00" ,"A" = "#E41A1C", "B" = "#377EB8", "BCD" = "#377EB8" , "NPP" = "#4DAF4A" ) 
...
doc44b <- lat44 %>% 
  ...
  scale_color_manual(values = custom.colors) +
  scale_fill_manual(values = custom.colors) +
 labs(x = expression("Days"), y = expression(paste("BDOC, µmol C L"^-1))) +
  theme_classic2(base_size = 16) +
  theme(legend.title = element_blank()) +
...
npp.boxplot <- bcd %>% 
  ...
  ggboxplot(., x = "Season", y = "int.NPP", 
            order = c("Early Spring", "Late Spring", "Early Autumn", "Early Winter"),
            xlab = F, 
...
ba.boxplot <- bcd %>% 
  ...
  ggboxplot(., x = "Season", y = "int.ba", 
            order = c("Early Spring", "Late Spring", "Early Autumn", "Early Winter"),
            xlab = F, 
            ylab = expression(paste("Bacterial Abundance, cells m"^-3)),
            add = "jitter",
            add.params = list(size = 2, shape = 21, fill = "white"),
            outlier.shape = NA,
            width = 0.5,
