...
```{r fig.height=8, fig.width=16, message=FALSE, warning=FALSE}
figure1 <- ba_curves / doc_curves + 
   plot_annotation(tag_levels = "a") &
  plot_layout(guides = "collect") +
  theme(plot.tag = element_text(size = 14))

# ggsave("f1.jpg", figure1, device = "jpg",  width = 16, height = 8, path = "~/Desktop/Bioavailability_MS/Submission1/figures/") 
```
...
```{r include = FALSE}
# ggsave("f3.jpg", bge_box, device = "jpg",  width = 7, height = 4, path = "~/Desktop/Bioavailability_MS/Submission1/figures/") 
```
...
```{r include = FALSE}
figure2 <- doc44a + theme(plot.tag = element_text(size = 14))

# ggsave("f2.jpg", figure2, device = "jpg",  width = 10, height = 7, path = "~/Desktop/Bioavailability_MS/Submission1/figures/") 
```
...
```{r include = FALSE}
figure4 <-  npp.boxplot / bp.boxplot / ba.boxplot  +  plot_annotation(tag_levels = "a") + plot_layout(guides = "collect") &
  theme(plot.tag = element_text(size = 14))

# ggsave("f4.jpg", figure4, device = "jpg",  width = 12, height = 12, path = "~/Desktop/Bioavailability_MS/Submission1/figures/") 
```
