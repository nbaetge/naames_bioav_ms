...
btl_vial_cell.data %>% 
  ...
  labs(x = expression(paste("Bottle Cells L"^-1)), y = expression(paste("Vial Cells L"^-1)), caption = "Dotted line represents the 1:1 line.") +
  scale_y_continuous(breaks = pretty_breaks()) +
  scale_x_continuous(breaks = pretty_breaks()) +
  custom_theme() +
   annotate( geom = "text", label = expression(atop("y = 1.07x - 87227207", paste("r"^2,"= 0.96, ", italic("p "), "<< 0.01"))), x = 2.5E9, y = 5.0E8, size = 3) +
