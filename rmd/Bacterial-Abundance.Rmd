...
```{r Master data reformat, message=FALSE}
...
```{r Unfiltered GC plots, include=F}
...
```{r Filtered GC plots, include=FALSE}
...
```{r GC sigma, echo = FALSE, warning = FALSE, message = FALSE, fig.height = 4, fig.width = 6}
gcdata %>% 
  ggplot(aes(x = sigma)) +
...
```{r df, echo = FALSE, warning = FALSE, message = FALSE, fig.height = 4, fig.width = 6}
gcdata %>% 
  ggplot(aes(x = df)) +
