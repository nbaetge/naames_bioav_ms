...
c_n.table <- fg_cell.rm %>% 
  select(initial_bactC_N:stationary_ncf) %>% 
  summary()

kable(c_n.table, caption = "Bacterioplankton C:N")
```
...
- CCFs
  + sspecially the AT38 values, which seem really high for open ocean during a stratified period
